...
import { UploadCloud, FileText, Activity, Layers, ArrowRight, Database } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { label: 'Total Managed Documents', value: library.length, icon: FileText, color: 'indigo' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="primary">{library.length} Objects</Badge>
          </div>
