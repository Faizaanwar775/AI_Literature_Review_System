...
# KRR Project Start Script
# Starts both backend and frontend servers in parallel

set -e

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║         🚀 KRR Project Startup Script                          ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "   Frontend (localhost): ${CYAN}http://localhost:5173${NC}"
echo "   Frontend (loopback):  ${CYAN}http://127.0.0.1:5173${NC}"
echo "   Backend (localhost):  ${CYAN}http://localhost:8000${NC}"
echo "   Backend (loopback):   ${CYAN}http://127.0.0.1:8000${NC}"
echo "   Backend API docs:     ${CYAN}http://localhost:8000/docs${NC}"
if [ -n "$LAN_IP" ]; then
